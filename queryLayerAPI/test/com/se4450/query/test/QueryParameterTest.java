...
public class QueryParameterTest {
	...
	public void testParseQueryString_buildingStartEnd() {
		...
		assertEquals(0, query.getSensorIDList().size());
	}
	...
	@Test
	public void testIsCorrectlyFormatted_correctSensor() {
		String queryString = "sensorID=1&start=123&end=123";
		...
		Boolean expected = true;
		Boolean actual = query.isCorrectlyFormatted();

		assertEquals(expected, actual);
	}
	
	@Test
	public void testIsCorrectlyFormatted_correctBuilding() {
		String queryString = "buildingID=1&start=123&end=123";
	...
	@Test
	public void testIsCorrectlyFormatted_incorrectBuildingSensor() {
		String queryString = "buildingID=1&sensorID=1&start=123&end=123";
	...
	@Test
	public void testIsCorrectlyFormatted_incorrectNoStart() {
		String queryString = "buildingID=1&end=123";
	...
	@Test
	public void testIsCorrectlyFormatted_incorrectNoEnd() {
		String queryString = "buildingID=1&start=123";
